...
public class UnityActionUpdateObjective
{
    ...
    public UnityActionUpdateObjective(Objective obj, string desText, string cntrText, bool isComplte, string notifText)
    {
        this.objective = obj;
        this.descriptionText = desText;
        this.counterText = cntrText;
        this.isComplete = isComplte;
